...
export const dashboard = graphql.query('Dashboard', () => {
      ...
      system: {
        data: {
          result: {
            ...
            uptime: {
              uptime: '1d 2h 18m 19s',
              load_average: { 1: 0, 5: 0, 15: 0 },
            },
            ram: {
              total: 2081341440,
              free: 1552891904,
          ...
          result: [
            {
              ...
              cpufamily: '15',
              model: '107',
              modelname: 'QEMU Virtual CPU version 2.5+',
              stepping: '1',
              microcode: '0x1',
              cpu_m_hz: '2399.998',
              cachesize: '16384 KB',
              ...
              clflushsize: '64',
              cache_alignment: '128',
              addresssizes: '40 bits physical, 48 bits virtual',
              powermanagement: '',
            },
          ],
        },
